...
char mqtt_user[25] = "";                                                                // Логин от сервер
char mqtt_pass[25] = "";                                                                // Пароль от сервера MQTT
char mqtt_name[25] = "ESP-12_Czasy";                                                    //"ESP-12_Informer";
char mqtt_sub_inform[25] = "Inform/mess";
char mqtt_sub[25] = "Ulica/temp";
char mqtt_pub_temp[25] = "Clock_ESP-12/temp";                                           //"ClockInformer/temp";
char mqtt_pub_tempUl[25] = "Clock_ESP-12/tempUl";                                       //"ClockInformer/tempUl";
char mqtt_pub_hum[25] = "Clock_ESP-12/hum";                                             //"ClockInformer/hum";
char mqtt_pub_press[25] = "Clock_ESP-12/press";                                         //"ClockInformer/press";
char mqtt_pub_alt[25] = "Clock_ESP-12/alt";                                             //"ClockInformer/alt";
bool mqttOn = true;
// =====================================================================================
bool printCom = true;
