...
<html>
    <head>
        ...
        <title>Informer_clock_weath на ESP8266 ver:11.2019.1x (By IvanUA)</title>
    ...
    <body onload = "load_times();">
        <header>
            <span class="opt_cn">INFORMER on ESP8266 ver:11.2019.1X (by IvanZah)</span><br>
        ...
        <central-unit>
            ...
            <div id="main_unit">
                ...
                <br>
                <label class="switch"><span class="opt_cn">RTC (on/off)</span>
                ...
                <br>
                <span class="save_booton" onclick="set_ntp_auto(this);">Setting Date/Time from PC</span>
            </div>
