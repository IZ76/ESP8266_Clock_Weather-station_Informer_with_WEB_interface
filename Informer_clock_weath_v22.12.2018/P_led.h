...
<html>
    <head>
        ...
        <title>Informer_clock_weath на ESP8266 ver:22.12.2018 (By IvanUA)</title>
        <link rel="shortcut icon" href="#" />
        <link rel = "stylesheet" type = "text/css" href = "/style.css">
        <script type = "text/javascript" src = "/function.js"></script>
        <script type = "text/javascript">
            function set_led(submit) {
                server = "/led?tbd=" + val('tbd') + "&vbd=" + val('vbd') + "&tbn=" + val('tbn') + "&vbn=" + val('vbn') + "&vba=" + val_sw('vba') + "&rotate0=" + val('rotate0') + "&rotate1=" + val('rotate1') + "&kuOn=" + val('kuOn') + "&kuOff=" + val('kuOff');
    ...
    <body onload = "load();">
        <header>
            <span class="opt_cn">INFORMER on ESP8266 ver: 22.12.2018 (by IvanZah)</span><br>
        ...
        <central-unit>
            ...
            <div id="main_unit">
                <center>
                    ...
                    <label class="switch"><span class="opt_cn">Show only big clocks at night (screen 4x2)</span>
                    ...
                    <table>
                        <tr>
                            ...
                            <td><select id = "sensorDom">
                                ...
                                <option value = "DHT22"> DHT11/22 </option>
                        ...
                        <tr>
                            <td align = "right"><span class="opt_cn">The pressure sensor</span></td>
                        ...
                        <tr>
                            <td align = "right"><span class="opt_cn">Screen rotation angle 0</span></td>
                        ...
                        <tr>
                            <td align = "right"><span class="opt_cn">Screen rotation angle 1</span></td>
                        ...
                        <tr><td align = "right">______________________</td></tr>
                        <tr>
                            <td align = "right"><span class="opt_cn">Amount modules line 0</span></td>
                        ...
                        <tr>
                            <td align = "right"><span class="opt_cn">Amount modules line 1</span></td>
                        ...
                        <tr>
                            <td align = "right"><span class="opt_cn">Size font clock</span></td>
                            <td><select id = "fontSizeCLOCK">
                                <option value = "0"> 8 lines </option>
                                <option value = "1"> 7 lines </option>
                            </select></td>
                        </tr>
                        <tr>
                            <td align = "right"><span class="opt_cn">Size font data</span></td>
                        ...
                        <tr>
                            <td align = "right"><span class="opt_cn">Data down</span></td>
                            <td><select id = "dataDown">
                                <option value = "0"> Not down </option>
                                <option value = "1"> Down </option>
                            </select></td>
                        </tr>
                        <tr>
                            <td align = "right"><span class="opt_cn">Text down</span></td>
