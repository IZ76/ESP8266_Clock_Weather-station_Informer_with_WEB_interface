...
void handle_led(){
  ...
  if(printCom) {
    printTime();
    Serial.println("TBD: "+String(timeDay)+", VBD: "+String(volBrightnessD)+", TBN: "+String(timeNight)+", VBN: "+String(volBrightnessN)+",  kuOn: "+String(kuOn)+",  kuOff: "+String(kuOff)+",  ds18b20: "+String(ds18b20)+", ds18b20Out: "+String(ds18b20Out)+", rotate: "+String(rotate)+", clockNight: "+String(clockNight)+", clockNight: "+String(clockNight));
  }
  saveConfig(); 
  server.send(200, "text/plain", "OK");
}
