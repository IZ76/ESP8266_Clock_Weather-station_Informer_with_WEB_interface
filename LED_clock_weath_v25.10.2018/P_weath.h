    ...
    <body onload = "load();">
        ...
        <central-unit>
            ...
            <div class="informer">
                ...
                <a href = "http://openweathermap.org/api" align = "center" target = "_blank">here we take the API key,</a> 
                <a href = "https://raw.githubusercontent.com/IZ76/ESP8266_Clock_Weather-station_Informer_with_WEB_interface/master/city_list.txt" align = "center" target = "_blank">but here we find the cityID of our city.</a>
            </div>
            <div id="main_unit">
                <center>
                    <table>
